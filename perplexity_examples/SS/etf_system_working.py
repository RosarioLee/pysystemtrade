...
ivv_data = pd.read_csv(
    "../data/futures/multiple_prices_csv/IVV.csv", index_col=0, parse_dates=True
)
hyd_data = pd.read_csv(
    "../data/futures/multiple_prices_csv/HYD.csv", index_col=0, parse_dates=True
)
